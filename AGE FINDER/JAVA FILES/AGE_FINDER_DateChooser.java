...
public class AGE_FINDER_DateChooser extends JDialog implements ItemListener, MouseListener, FocusListener, KeyListener, ActionListener 
{
...
//----------------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------------
    public AGE_FINDER_DateChooser(Dialog owner, String title)
    {
        super(owner, title, true);
        construct();
    }
  //----------------------------------------------------------------------------------------------
    public AGE_FINDER_DateChooser(Dialog owner) 
    {
        super(owner, true);
        construct();
    }
  //----------------------------------------------------------------------------------------------
    public AGE_FINDER_DateChooser(Frame owner, String title) 
    {
        super(owner, title, true);
        construct();
    }
  //----------------------------------------------------------------------------------------------
    public AGE_FINDER_DateChooser(Frame owner) 
    {
        super(owner, true);
        construct();
